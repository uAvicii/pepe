...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/register', component: () => import('@/view/Register/index.vue'), meta: { title: '注册' } },
    {
      path: '/', component: () => import('@/view/Layout/index.vue'),
      redirect: "/home",
      children: [
    ...
    { path: "/consult", component: () => import("@/view/User/consult/index.vue"), meta: { title: '问诊' }, name: "Consult", },
    { path: "/patient", component: () => import("@/view/User/patient/index.vue"), meta: { title: '档案' }, name: "patient", },
    { path: "/address", component: () => import("@/view/User/address/index.vue"), meta: { title: '地址' }, name: "address", },
