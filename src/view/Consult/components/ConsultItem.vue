...
import { ref } from 'vue'
import { cancelOrderAPI, deleteOrderAPI } from '@/services/consult'
...
<template>
  <div class="consult-item">
    ...
    <div class="foot" v-if="item.status === OrderType.ConsultCancel">
      <van-button class="gray" plain size="small" round :loading="delLoading" @click="onDel(item!)"
        >删除订单</van-button
      >
